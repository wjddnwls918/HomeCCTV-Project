                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                           ...
                           /* for (int i = 0; i < list_cnt; i++) {
                                ...
                                Log.d("get data",getIdx[i]+" "+getTemperature[i]+" "+getHumidity[i]+" "+getppm[i]+" "+getflameState[i]+" "+gethumStata[i]+" "+getinputtime[i]);
                            }*/
...
*/
        ...
        for (int i = 0; i < list_cnt-1; i++) {
           ...
           /* getIdx[i] = Integer.parseInt(jsonObject.getString("idx")) ;*/
            ...
            /*getflameState[i] = Integer.parseInt(jsonObject.getString("flameState"));
            gethumStata[i] = Integer.parseInt(jsonObject.getString("humState"));
    ...
    }catch(JSONException e)
    {
     ...
     /*   entries2.add(new Entry(1, 20));
        ...
        entries2.add(new Entry(3, 40));
        entries2.add(new Entry(4, 50));
        entries2.add(new Entry(5, 20));
      ...
      /*  entries3.add(new Entry(1, 200));
        entries3.add(new Entry(2, 250));
        entries3.add(new Entry(3, 230));
        entries3.add(new Entry(4, 220));
        entries3.add(new Entry(5, 250));
        entries3.add(new Entry(6, 210));*/
